var r=Object.defineProperty;var c=(e,s,t)=>s in e?r(e,s,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[s]=t;var a=(e,s,t)=>c(e,typeof s!="symbol"?s+"":s,t);import{i as p,s as u,C as b,a as m,k as v}from"./index-BOfqQVcM.js";import{L as g}from"./letter.service-D26VPjMO.js";var x=Object.getOwnPropertyDescriptor,h=(e,s,t,d)=>{for(var i=d>1?void 0:d?x(s,t):s,l=e.length-1,n;l>=0;l--)(n=e[l])&&(i=n(i)||i);return i};let o=class{constructor(){a(this,"letterService",p(g));a(this,"newCode","");a(this,"newName","");a(this,"newSubCode","");a(this,"selectedClass",u(null))}getActiveClass(){return this.letterService.classifications().find(e=>e.id===this.selectedClass())}addCode(){this.newCode&&this.newName&&(this.letterService.addClassification(this.newCode,this.newName),this.newCode="",this.newName="")}addSub(){const e=this.selectedClass();e&&this.newSubCode&&(this.letterService.addSubCode(e,this.newSubCode),this.newSubCode="")}};o=h([b({selector:"app-settings",imports:[v],template:`

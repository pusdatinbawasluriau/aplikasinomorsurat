var d=Object.defineProperty;var c=(t,e,s)=>e in t?d(t,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[e]=s;var i=(t,e,s)=>c(t,typeof e!="symbol"?e+"":e,s);import{i as p,b as u,C as g,a as m,d as x,R as b,e as v}from"./index-BOfqQVcM.js";var f=Object.getOwnPropertyDescriptor,h=(t,e,s,n)=>{for(var r=n>1?void 0:n?f(e,s):e,a=t.length-1,o;a>=0;a--)(o=t[a])&&(r=o(r)||r);return r};let l=class{constructor(){i(this,"router",p(u))}logout(){sessionStorage.removeItem("admin_token"),this.router.navigate(["/login"])}};l=h([g({selector:"app-admin-layout",imports:[x,b,v],template:`
